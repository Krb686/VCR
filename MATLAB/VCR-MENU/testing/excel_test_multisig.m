global confidenceReport factor FEATURES cmd_list METHOD testRuns
...
datFile_options = {'D_Dave_Num'};
refFile_options = {'D_Dave_Num', 'R_Dave_num'};
...
for iFile = 1:length(refFile_options)
    ...
    for iDFile = 1:length(datFile_options)
        ...
        disp(['putting  ' datFile ' onto ' sheetNames{iFile} ' in spot ' num2str(spot)])
